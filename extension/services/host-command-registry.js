...
const MARKDOWN_RESULT_CONTRACT = {
    type: 'implemented',
    probe: 'markdown',
...
export const PICKLE_COMMAND_SPECS = [
    ...
    { name: 'ants-in-my-eyes-johnson', description: 'Prepare an accessibility audit report plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    ...
    { name: 'blips-and-chitz', description: 'Prepare a GitNexus coverage-analysis artifact skeleton.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'butter-robot', description: 'Prepare a minimal daemon scaffold preview plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    ...
    { name: 'death-crystal', description: 'Prepare a GitNexus impact-analysis artifact for a symbol.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    ...
    { name: 'evil-morty', description: 'Prepare a non-destructive security review plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'fleeb-juice', description: 'Return the skeleton-only secret rotation safety contract.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'froopyland', description: 'Return the skeleton-only sandbox safety contract.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'galactic-federation', description: 'Run a runtime observability audit skeleton.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'gazorpazorp', description: 'Prepare a non-destructive monorepo scaffold plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'get-schwifty', description: 'Prepare a benchmark and load-profile report plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'ghost-in-a-jar', description: 'Show the skeleton-only persistence command contract.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'glorzo', description: 'Prepare a focused runtime observability view.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'help-pickle', description: 'Show Pickle Rick command help.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'interdimensional-cable', description: 'Parse and supervise service log streams.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'interdimensional-customs', description: 'Prepare a non-destructive downstream safety plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    ...
    { name: 'microverse-battery', description: 'Validate nested-container devstack plans without starting containers by default.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'mr-poopybutthole', description: 'Summarize companion runtime session state.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'nimbus', description: 'Return the skeleton-only cloud provisioning safety contract.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'operation-phoenix', description: 'Prepare a GitNexus clone-analysis artifact skeleton.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'phoenix-person', description: 'Return the skeleton-only deploy rollback safety contract.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    ...
    { name: 'portal-fluid', description: 'Prepare a GitNexus dependency graph artifact.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'project-mayhem', description: 'Run chaos engineering workflow.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'scary-terry', description: 'Prepare a non-destructive API fuzz plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'detoxifier', description: 'Preview cleanup-oriented refactor suggestions.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'doofus-rick', description: 'Preview explainer-oriented code understanding notes.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'jerry-detector', description: 'Preview technical debt findings and remediation ideas.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'memory-parasites', description: 'Preview dead-code and stale-code findings.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'simple-rick', description: 'Preview simplicity-focused refactor suggestions.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'squanch', description: 'Preview regex search/replace changes with rollback artifacts.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    ...
    { name: 'rickmobile', description: 'Prepare a responsive frontend audit matrix.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'ricks-flask', description: 'Prepare schema-driven mock data seed previews.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'ricks-garage', description: 'Prepare a deterministic local dev bootstrap environment plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'morty-smith-database', description: 'Prepare schema migration plan artifacts without applying migrations.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'snake-jazz', description: 'Prepare bounded retry plan artifacts without starting processes.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'time-crystal', description: 'Prepare a bundle and build timing report plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    { name: 'tiny-rick', description: 'Prepare a build optimization report plan.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    ...
    { name: 'unity', description: 'Prepare a package scaffold preview plan without writing package files.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
    ...
    { name: 'wendys', description: 'Return the skeleton-only destructive rollback safety contract.', hosts: BACKENDS, resultContract: MARKDOWN_RESULT_CONTRACT },
