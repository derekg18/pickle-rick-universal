...
function listProjectSlugs(projectsDir) {
    try {
...
function listSessionJsonlFiles(projectsDir, slug) {
...
function getCachedSessionFileData(filePath, cache) {
    let fstat;
    try {
...
function addSessionFileData(result, slug, fileData, since, until) {
...
function pruneStaleCacheEntries(cache, validPaths) {
    let changed = false;
