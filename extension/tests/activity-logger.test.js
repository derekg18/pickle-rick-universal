...
test('VALID_ACTIVITY_EVENTS contains all 55 expected event types', () => {
    const expected = [
        ...
        'circuit_open', 'circuit_recovery', 'jerry_mode_pause',
    ...
    assert.equal(VALID_ACTIVITY_EVENTS.length, 55);
