...
4. If no violations found: write `szechuan-sauce.json` with `{"converged": true, "reason": "zero actionable violations", "findings": []}`, print "The sauce is obtained.", and exit cleanly
