Preview cleanup-oriented refactor suggestions.

Run the shared quality/refactor helper:

```bash
node "/Users/derekgreene/.gemini/extensions/pickle-rick/extension/bin/quality-refactor-command.js" detoxifier $ARGUMENTS
```
